...
export const ERROR_MESSAGES = {
  ...
  OPENAI_API_KEY_REQUIRED: 'OpenAI API key is required. Please set your API key in your profile.',
  OPENAI_API_KEY_REQUIRED_FOR_SUMMARIZATION: 'OpenAI API key is required for summarization',
  ...
  FAILED_TO_CREATE_AGENT_MEMORY: 'Failed to create agent memory: no result returned',
} as const;
